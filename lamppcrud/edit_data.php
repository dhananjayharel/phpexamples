...
if(isset($_POST['btn-update']))
{
	...
	$update_query = "UPDATE users SET first_name='$first_name',last_name='$last_name',user_city='$city_name' WHERE id=".$_GET['edit_id'];
	// sql query for update data into database
      $update = $db->exec($update_query);
